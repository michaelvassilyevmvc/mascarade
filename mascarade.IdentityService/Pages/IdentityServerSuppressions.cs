...
[assembly:
    SuppressMessage("Design", "CA1002:Do not expose generic lists",
        ...
        Target = "~P:mascarade.IdentityService.TestUsers.Users")]
[assembly:
    SuppressMessage("Design", "CA1034:Nested types should not be visible",
        Justification = "ExternalProvider is nested by design", Scope = "type",
        Target = "~T:mascarade.IdentityService.Pages.Login.ViewModel.ExternalProvider")]
[assembly:
    SuppressMessage("Naming", "CA1716:Identifiers should not match keywords",
        Justification = "This namespace is just for organization, and won't be referenced elsewhere",
        Scope = "namespace", Target = "~N:mascarade.IdentityService.Pages.Error")]
[assembly:
    SuppressMessage("Naming", "CA1724:Type names should not match namespaces",
        Justification =
            "Namespaces of pages are not likely to be used elsewhere, so there is little chance of confusion",
        Scope = "type", Target = "~T:mascarade.IdentityService.Pages.Ciba.Consent")]
[assembly:
    SuppressMessage("Naming", "CA1724:Type names should not match namespaces",
        Justification =
            "Namespaces of pages are not likely to be used elsewhere, so there is little chance of confusion",
        Scope = "type", Target = "~T:mascarade.IdentityService.Pages.Extensions")]
[assembly:
    SuppressMessage("Performance", "CA1805:Do not initialize unnecessarily",
        ...
        Target = "~F:mascarade.IdentityService.Pages.Logout.LogoutOptions.AutomaticRedirectAfterSignOut")]